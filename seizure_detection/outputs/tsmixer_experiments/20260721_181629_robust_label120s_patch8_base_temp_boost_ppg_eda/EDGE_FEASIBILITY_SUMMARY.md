...
- Detection timestamp: 2026-07-21T22:35:41.176369
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| Standard | `standard_acc_only` | 2185.7 KB | 155,729 | 661.7 KB | 244.1 KB | 278.3 KB |
...
| --- | ---: | ---: | --- |
| Standard | 262.3 KB | 11.1665 ms | int8 -> int8 |
| Pro | 262.9 KB | 12.3574 ms | int8 -> int8 |
