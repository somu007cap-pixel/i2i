...
- Detection timestamp: 2026-07-20T05:31:44.904419
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| Standard | `standard_acc_only` | 2185.7 KB | 155,729 | 661.7 KB | 244.1 KB | 278.4 KB |
...
| --- | ---: | ---: | --- |
| Standard | 262.3 KB | 8.8479 ms | int8 -> int8 |
| Pro | 262.9 KB | 7.5923 ms | int8 -> int8 |
