...
- Detection timestamp: 2026-07-04T15:51:33.774661
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| Standard | `standard_acc_eda_temp` | 2185.8 KB | 155,729 | 663.1 KB | 245.6 KB | 282.1 KB |
| Pro | `pro_full_bvp_hr_eda_temp` | 2185.8 KB | 155,729 | 663.4 KB | 245.8 KB | 282.1 KB |

## Profiling Notes

| Tier | Current calibrated TFLite tensor proxy | PC TFLite median latency | Input/output dtype |
| --- | ---: | ---: | --- |
| Standard | 262.9 KB | 7.6255 ms | int8 -> int8 |
| Pro | 262.9 KB | 7.5100 ms | int8 -> int8 |
