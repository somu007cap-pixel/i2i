...
- Detection timestamp: 2026-07-05T02:34:58.623541
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| Standard | `standard_acc_temp` | 2185.7 KB | 155,729 | 661.7 KB | 244.1 KB | 278.7 KB |
...
| --- | ---: | ---: | --- |
| Standard | 262.3 KB | 17.8310 ms | int8 -> int8 |
| Pro | 262.9 KB | 10.0897 ms | int8 -> int8 |
